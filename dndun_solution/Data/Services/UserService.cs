...
namespace dndun_solution.Data.Services
{
	public class UserService :IUserService
	{
        ...
        public async Task<dynamic> Register(UserForRegister userForRegister)
        {
            ...
            await _context.SaveChangesAsync();
            return new {Code = Code,status =true };
        }
        ...
        public async Task<dynamic> LoginAdmin(AdminForLoginRequest adminForLogin)
        {
        ...
        public async Task<dynamic> LoginUser(UserForLogin userForLogin)
        {
            ...
            await _context.SaveChangesAsync();
            if (loginUser != null && userForLogin.Code == loginUser.Code)
            {
                var Token = await GeneratTokenAsync(loginUser);
                return new
                {
